		...
		return { //this:ActionBasciFsm
				...
				state("perceive") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t04",targetState="handleVrinfoMsg",cond=whenDispatch("vrinfo"))
					transition(edgeName="t05",targetState="handleVrinfoEvent",cond=whenEvent("vrinfo"))

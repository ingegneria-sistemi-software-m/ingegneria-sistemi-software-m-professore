...
public class EurekaServiceConfig extends MyDataCenterInstanceConfig{  
	...
	public String getAppname( ) {
		CommUtils.outgreen("EurekaServiceConfig  | getAppname " + Thread.currentThread());
		return "ctxeureka";
	}
	
	@Override
	public String getHostName(boolean refresh) {
//		CommUtils.outgreen("EurekaServiceConfig|getHostName"    
 ...
 */
	...
	public int getNonSecurePort() {
		CommUtils.outblack("EurekaServiceConfig  | getNonSecurePort 8443" + Thread.currentThread());
		return 8443;
	}
	/* 

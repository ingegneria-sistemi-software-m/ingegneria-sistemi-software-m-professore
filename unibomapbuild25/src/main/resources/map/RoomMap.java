...
/*
 * La mappa è rappresentata come un lista di liste di Box
 * Una Box memorizza conoscenze su una cella 
 */
public class RoomMap implements Serializable{
	...
	public boolean docleanTheMap() {
		...
		while( i <= getDimX()-1 ) {
			...
			if( rowDirty ){
				roomMap.remove(i);
				System.out.println( "eliminata riga i="+ i + " dimX=" + getDimX() + " dimY=" + getDimY() );				
				return true;
			}
			i = i + 1;
		}

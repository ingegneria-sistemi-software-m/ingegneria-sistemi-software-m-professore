...
dispatch( allnbreceived, allnbreceived(N) ).
%====================================================================================
context(ctxcellalone, "localhost",  "TCP", "8360").
context(ctxmaster, "discoverable",  "TCP", "8260").
 qactor( gamemaster, ctxmaster, "external").
  qactor( cell0000, ctxcellalone, "it.unibo.cell0000.Cell0000").
 static(cell0000).
  qactor( perceiver, ctxcellalone, "it.unibo.perceiver.Perceiver").
 static(perceiver).

...
public class CellCmdTranslator {
	...
	public IApplMessage cvtToApplicMessage( String msg ) {
		...
		//Invio messaggi in forma di autodispatch
			...
			// tutti i thread non-daemon abbiano completato il loro lavoro. 
 			applMsg = CommUtils.buildEvent( owner.getName(), "exitCmd", "exitCmd(fromgui)" );
			//System.exit(0); 
		}
		//CommUtils.outyellow("cvtToApplMessage  return:" + applMsg);
 		return applMsg;
		}

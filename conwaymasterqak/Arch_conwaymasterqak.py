...
with Diagram('conwaymasterqakArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     gamemaster >> Edge( label='allcellready', **eventedgeattr, decorate='true', fontcolor='red') >> sys
